...
const Sticker = ({ emoji, className = "", style = {}, rotate = 0 }) => {
  ...
  return (
    <motion.div 
      ...
      className={`sticker-chip absolute bg-white flex items-center justify-center rounded-full ${isInteractive ? 'pointer-events-auto' : 'pointer-events-none'} z-10 ${className}`}
      style={{
